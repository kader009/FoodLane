        ...
        <div className=" bg-black text-white">
          ...
          <section className="container mx-auto py-2">
            ...
            {loading ? (
              ...
              <Container>
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 justify-center items-center justify-items-center">
                  {filteredItems.map((food) => (
                    <div
                      key={food._id}
                      className="w-[24rem] rounded overflow-hidden shadow-lg bg-white text-black mx-8 mb-6"
                    >
                      <img
