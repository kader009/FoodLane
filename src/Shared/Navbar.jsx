...
const Navbar = () => {
  ...
  <div className="flex-none gap-2">
    ...
    <div className="dropdown dropdown-end lg:hidden">
      ...
      <ul
        tabIndex={0}
        className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-gray-950 rounded-box w-52"
      >
        <li>
          <Link to="/">Home</Link>
        </li>
        ...
        {user ? (
          <>
            ...
            <li>
              <button
                onClick={logOut}
                className="bg-blue-600 text-white flex justify-center items-center hover:bg-blue-900"
              >
                Logout
              </button>
            </li>
    ...
    <div className="hidden lg:flex items-center gap-2">
      ...
      {user && (
        <div className="dropdown dropdown-end">
          ...
          <ul
            tabIndex={0}
            className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 dark:bg-gray-900 rounded-box w-52"
          >
            <li>
